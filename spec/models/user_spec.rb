...
RSpec.describe User, type: :model do
  before :all do
    @author = User.create(name: 'Tom', photo: 'https://images513-2c110a25bd8c&q=80', bio: 'I am a teacher from Mexico',posts_counter: 0)
    Post.create(author: @author, title: 'post 1', text: 'text 1', comments_counter: 0,likes_counter: 0)
    Post.create(author: @author, title: 'post 2', text: 'text 2', comments_counter: 0, likes_counter: 0)
    Post.create(author: @author, title: 'post 3', text: 'text 3', comments_counter: 0,likes_counter: 0)
  end
